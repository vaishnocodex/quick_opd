                ...
                <div class="sidebar-menu">
                    <ul>
                        <li class="{{ Route::currentRouteName()==" admin.home"?"active":"" }}">
                           ...
                           <li class="{{ Route::currentRouteName()=="admin.patient"?"active":"" }}">
                        ...
                        <li class="sidebar-dropdown{{ Route::currentRouteName()==" javascript:void(0)"?"active":"" }}">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.doctor') }}" class="{{ Route::currentRouteName()=="
                                            admin.doctor"?"current-page":"" }}">All doctor</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.new.doctor') }}" class="{{ Route::currentRouteName()=="
                                            admin.new.doctor"?"current-page":"" }}">Add doctor</a>
                                    </li>
                          ...
                          <li class="sidebar-dropdown{{ Route::currentRouteName()==" javascript:void(0)"?"active":"" }}">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{ route('admin.hospital.appointment') }}" class="{{ Route::currentRouteName()=="
                                            admin.category"?"current-page":"" }}">Hospital </a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.radiology.appointment') }}"
                                            class="{{ Route::currentRouteName()=="
                                            admin.radiology.category"?"current-page":"" }}">Radiology </a>
                                    </li>
                        ...
                        <li class="sidebar-dropdown{{ Route::currentRouteName()==" javascript:void(0)"?"active":"" }}">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('admin.hospital.balance-sheet')}}"
                                            class="{{ Route::currentRouteName()=="
                                            admin.hospital.balance-sheet"?"current-page":"" }}">Balance Sheet</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        <li class="sidebar-dropdown{{ Route::currentRouteName()==" javascript:void(0)"?"active":"" }}">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{route('admin.profile')}}" class="{{ Route::currentRouteName()=="
                                            admin.profile'"?"current-page":"" }}">Profile</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.firm-detail')}}" class="{{ Route::currentRouteName()=="
                                            admin.firm-detail'"?"current-page":"" }}">Firm Detail</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
