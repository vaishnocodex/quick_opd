            ...
            <div class="card">
                <div class="card-body">
                    @include('admin.message')
                     ...
                     <form method="POST" action="{{ route('admin.radiology.add') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row gutters">
                            <input type="hidden" name="hospital_type" value="radiology">
                            ...
                            <!-- Submit Button -->
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <button type="submit" class="btn btn-primary">Add Radiology</button>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="row gutters mt-4">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="table-container">
                                <div class="t-header" style="text-align: center; font-size: 18px;">All Radiology</div>
