...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.14/css/bootstrap-select.min.css">
    ...
    <div class="main-container">
      <div class="page-header">
        <!-- Breadcrumb start -->
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Edit Radiology Detail</li>
        </ol>
        <!-- Breadcrumb end -->
    </div>
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('admin.radilogy.update') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row gutters">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required value="{{$data->name}}" class="form-control" name="name" id="name" placeholder="Enter Radiology Name" />
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="address">Select Radiology Location <span style="color:red">*</span></label>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <button type="submit" class="btn btn-primary"> Edit Radiology</button>
                            </div>
                        </div>
                    </form>
