                            ...
                            <div class="tab-content account dashboard-content pl-50">
                                <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <p>
                                                From your account dashboard. you can easily check &amp; view your <a href="#">recent Bookings</a>,<br />
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="POST" action="{{ route('user.update-password') }}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <button type="submit" class="btn btn-fill-out submit font-weight-bold">Update Password</button>
                                                    </div>
                                                </div>
                                            </form>
