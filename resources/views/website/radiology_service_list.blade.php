            ...
            <div class="mt-4">
                <div class="products-listing position-relative">
                    ...
                    <div class="shop-product-filter">
                        <p><strong class="text-brand">{{$radiology->name}}</strong> </p>
                                ...
                                <div class="product-content-wrap">
                                    ...
                                    <h2 class="text-truncate"><a href="{{ route('doctor.detail', ['id'=>Crypt::encrypt($item->id)]) }}" title="{{$item->name}}">{{$item->name}}</a> </h2>
                                     <ul class="available-info">
                                            ...
                                            <li> <i class="far fa-clock"></i>  {{$item->experience}} Experience
                                            </li>
                                    ...
                                    <div class="product-card-bottom d-md-flex d-block">
                                        ...
                                        <div class="add-cart">
                                            <a class="action-btn add mt-md-0 mt-3" href="{{ route('radiology.detail', ['id'=>Crypt::encrypt($item->id)]) }}">
