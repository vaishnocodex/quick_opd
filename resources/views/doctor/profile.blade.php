                ...
                <div class="row gutters">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" required class="form-control" value="{{ $data->name }}" name="name" id="name" placeholder="Enter Doctor Name" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" required pattern="[0-9]{10}" maxlength="11" value="{{ $data->mobile_no }}" class="form-control" name="mobile" id="mobile" placeholder="Enter Mobile" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" name="image" id="image" @if(!$data->image) required @endif />
                            @if($data->image)
                                <img src="{{ asset('storage/doctor/' . $data->image) }}" style="height:70px;width:70px;" alt="Doctor Image">
                            @endif
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="email" required value="{{ $data->email }}" class="form-control" name="email" id="email" placeholder="Enter Email" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" maxlength="11" class="form-control" value="{{ $data->experience }}" name="experience" id="experience" placeholder="Enter Experience" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" required value="{{ number_format($data->price, 2) }}" class="form-control" name="price" id="price" placeholder="Enter Price" />
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker11" name="category_id[]" multiple data-live-search="true">
                                @foreach ($category_data as $item)
                                    <option value="{{ $item->id }}" @if(in_array($item->id, explode(',', $data->category_id))) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select class="form-control selectpicker11" name="symptom_id[]" multiple data-live-search="true">
                                @foreach ($symptom_data as $item)
                                    <option value="{{ $item->id }}" @if(in_array($item->id, explode(',', $data->symptom_id))) selected @endif>{{ $item->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
