...
<div class="main-container">
    ...
    <div class="row gutters">
                            ...
                            <div class="table-container">
                                ...
                                <form method="GET" action="{{ url()->current() }}" id="filterForm">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-4">
                                            <label for="doctorFilter">Filter by Service:</label>
        ...
        '{{ $val->email }}'
                                                        ...
                                                        <a href="{{ route('upload.report',['id'=>encrypt($val->id)]) }}" class="btn btn-sm btn-primary">Report Upload</a>
                                                    </td>
                                                    <td>{{ $val->order_id }}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row gutters">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="doctor_id">Select Service:</label>
...
<script>
    $(document).ready(function () {
        $('#appointmentForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '{{ route("radiology.appointment.create") }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType: false,
