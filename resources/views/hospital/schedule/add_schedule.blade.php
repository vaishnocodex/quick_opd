        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <button type="button" class="btn btn-primary m-3" onclick="Add_slot()">
                    <i class="icon-add"></i> &nbsp;Add Schedule
                </button>
            </li>
        </ol>
    </div>
    ...
    <div class="row gutters mt-4">
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="table-container">
                <div class="t-header" style="text-align: center; font-size: 18px;">Schedule List</div>
            ...
            <form id="slotForm">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Add Your  Schedule - <span id="selectedDate"></span></h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row gutters">
                            ...
                            <input type="hidden" name="doctor_id" value="{{Auth::guard('hospital')->user()->id}}">
                            <div class="col-md-4">
...
<script>
  ...
  $('#slotForm').on('submit', function (e) {
    e.preventDefault();
    $.ajax({
      url: '{{ route('radiology-service-slots.generate') }}',
      method: 'POST',
      data: $(this).serialize(),
