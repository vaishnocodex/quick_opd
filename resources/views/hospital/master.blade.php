                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown{{ Route::currentRouteName()=="javascript:void(0)"?"active":"" }}">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
                                        <a href="{{ route('hospital.doctor.index') }}" class="{{ Route::currentRouteName()=="hospital.doctor.index"?"current-page":"" }} active">All doctor</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('hospital.doctor.create') }}" class="{{ Route::currentRouteName()=="hospital.doctor.create"?"current-page":"" }}">Add doctor</a>
                                    </li>
                                </ul>
                            </div>
                        </li>   
