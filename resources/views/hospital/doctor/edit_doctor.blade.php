        ...
        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('hospital.doctor.update') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row gutters">
                            {{-- <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="hospital" name="hospital" required>
                                        ...
                                        <option value="{{$item->id}}" @if($data->user_id==$item->id) selected
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required class="form-control" value="{{$data->name}}" name="name"
                                        id="name" placeholder="Enter Hospital Name" />
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text " required value="{{$data->mobile_no}}" pattern="[0-9]{10}"
                                        maxlength="11" class="idm form-control" name="mobile" id="mobile"
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control" name="image" id="image" placeholder="Enter"
                                        @if(!$data->image) required @endif />
                                    @if($data->image) <img src="{{ asset('storage/doctor/').'/'.$data->image}}"
                                        style="height: 70px;width:70px;"> @endif
                                </div>
                            </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="11" class="idm form-control"
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="getcity" name="city" required>
                                        ...
                                        <option value="{{$item->id}}" @if($data->city==$item->id) selected
                                            @endif>{{$item->name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" required value="{{$data->price}}"
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker11 form-control" name="symptom_id[]" multiple
                                        ...
                                        <option value="{{ $item->id }}" @if(in_array($item->id, explode(',',
                                            $data->symptom_id))) selected @endif>
                                            {{ $item->name }}
                                        </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-6 col-12">
                                <div class="form-group">
                                    <label for="address">Select Hospital Location <span
