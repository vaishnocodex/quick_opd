...
class VendorController extends Controller
{
    ...
    function patient()
    {
        $patient =   $orders = DB::table('orders as a')
            ->select([
                'a.*',
    ...
    function patient_profile($id)
    {
        ...
        return view('admin.profile_view', compact('reports', 'patient'));
    }
    ...
    public function HospitalLedgerReport(Request $request)
    {
        ...
        $results = DB::table('users')
            ...
            ->select(
                ...
                'users.name',
                'users.email',
                'users.mobile_no', // Add all columns here
